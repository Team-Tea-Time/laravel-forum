...
class Thread extends BaseModel
{
    ...
    */
    ...
    {
        return $this->getRoute('forum.api.thread.update', ['thread' => $this->id]);
    }

    public function getDeleteRouteAttribute()
    {
        return $this->getRoute('forum.api.thread.destroy', ['thread' => $this->id]);
    }

    public function getRestoreRouteAttribute()
    {
        return $this->getRoute('forum.api.thread.restore', ['thread' => $this->id]);
    }

    public function getForceDeleteRouteAttribute()
    {
        return $this->getRoute('forum.api.thread.destroy', ['thread' => $this->id, 'force' => 1]);
    }
