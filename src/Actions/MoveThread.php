...
class MoveThread extends BaseAction
{
    ...
    protected function transact()
    {
        ...
        Thread::withoutTimestamps(fn () => $this->thread->update(['category_id' => $this->destinationCategory->id]));
        ...
        Category::withoutTimestamps(fn () => $sourceCategory->update($sourceCategoryValues));

        Category::withoutTimestamps(fn () => $this->destinationCategory->update([
