        ...
        <div class="row align-items-center text-center">
            ...
            <div class="col-sm-2 text-md-end">
                @if ($category->accepts_threads)
                    <span class="badge rounded-pill bg-primary" style="background: {{ $category->color_light_mode }};">
            ...
            @foreach ($category->children as $subcategory)
                <div class="list-group-item">
                    <div class="row align-items-center text-center">
                        ...
                        <div class="col-sm-2 text-md-end">
                            <span class="badge rounded-pill bg-primary" style="background: {{ $subcategory->color_light_mode }};">
